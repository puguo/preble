...
class DataParallelRequestRouter:
    ...
    def select_runtime(self, text, experiment_id, request_id, input_ids=None, sampling_params=None, current_time_stamp=None, runtime_id_with_highest_hit_rate=None, hit_rates=None,loaded_gpu_list=None, waiting_queues=None, cache_weight=None, queue_penalty_weight=None, **kwargs) -> int:
